  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://github.com/ShashankChandgude"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/shashank-chandgude/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with React and ❤️ by Shashank</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
